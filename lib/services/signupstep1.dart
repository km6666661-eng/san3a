  ...
  Future<void> _goToNextStep() async {
    ...
    if (phone.isEmpty) {
      ...
      hasError = true;
        ...
        !RegExp(r'^01[0125][0-9]{8}$').hasMatch(phone)) {
      _phoneError =
    ...
    // كل الحقول شكلها صح، دلوقتي نتأكد إنها مش مكررة في Firestore
    ...
    try {
      ...
      final nationalIdTaken = await firestoreService.isNationalIdTaken(
        nationalId,
      );
      ...
      // ده بيطبع رسالة الخطأ الحقيقية في الـ console (مش في الشاشة).
      // لو المشكلة استمرت، انسخلي اللي هيطلع هنا بالظبط.
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'حدث خطأ أثناء التحقق من البيانات. تأكد من الاتصال بالإنترنت وحاول مرة أخرى.',
          ),
        ),
      );
    }
  ...
  InputDecoration _inputDecoration(
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: Color(0xFF1557D0), width: 1.5),
      ),
