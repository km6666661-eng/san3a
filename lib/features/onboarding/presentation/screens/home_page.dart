...
class _HomePageState extends State<HomePage> {
  ...
  void onFilterTap(String categoryKey) {
    final isActive = selectedCategory == categoryKey;
    setState(() {
      selectedCategory = isActive ? null : categoryKey;
    });
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) =>
            ServicesPage(initialCategory: isActive ? null : categoryKey),
      ),
    );
  }
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) => ProviderProfileScreen(
              name: t.name.trim(),
              profession: t.category,
              rating: t.rating.toStringAsFixed(1),
              reviewCount: t.reviews.replaceAll(RegExp(r'[()\s]'), ''),
