...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  String fullName = 'أبرام انور';
  String email = 'abram@example.com';
  String phone = '+20 112 345 6789';
  String location = 'القاهرة، مصر';
  String joinDate = 'يناير 2024';
  ...
  Widget _editButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isEditing ? AppColors.orange2 : Colors.white.withOpacity(0.15),
